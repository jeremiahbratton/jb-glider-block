...
/***/ "./src/glider/dependency/glider.min.js":
/*!*********************************************!*\
  !*** ./src/glider/dependency/glider.min.js ***!
  \*********************************************/
  ...
  gliderPrototype.updateControls = function (event) {
    ...
    [].forEach.call(_.slides, function (slide, index) {
      ...
      [].forEach.call(slideClasses, function (className) {
        /^glider-left|glider-right/.test(className) && slideClasses.remove(className);
      });
      ...
      if (middle === index || extraMiddle && extraMiddle === index) {
        ...
        slideClasses.add([index < middle ? 'glider-left' : 'glider-right', Math.abs(index - (index < middle ? middle : extraMiddle || middle))].join('-'));
      }
...
/******/ 	var __webpack_exports__ = __webpack_require__("./src/glider/dependency/glider.min.js");
/******/ 	
/******/ })()
;
